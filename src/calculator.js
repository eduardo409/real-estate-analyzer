...
class Analyser {
    constructor(asset, loan, down, income, expense, vacancy, closingCost) {
        this.asset = asset;
        this.loan = loan;
    ...
    calculateDownPayment() { return this.getPercentDown() * this.getAsset().getValue() }
    // calculate leverage: asset valule - downpayment 
    calculateLeverage() { return this.getAsset().getValue() - this.calculateDownPayment() }
    // closing cost value
    calculateClosingCost() { return this.getPercentClosingCost() * this.calculateLeverage() }
    ...
    calculateEGI() { return this.getIncome() - this.getVacancy() };
    // Calculate Net Operating Income: EffectiveGrossincome - expenses
    calculateNOI() { return this.calculateEGI() - this.getExpense() };
